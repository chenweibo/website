<?php if (!defined('THINK_PATH')) exit(); /*a:4:{s:72:"G:\xampp\htdocs\jieapi\public/../application/admin\view\slide\slide.html";i:1488333950;s:74:"G:\xampp\htdocs\jieapi\public/../application/admin\view\public\header.html";i:1490082824;s:72:"G:\xampp\htdocs\jieapi\public/../application/admin\view\public\left.html";i:1490251414;s:74:"G:\xampp\htdocs\jieapi\public/../application/admin\view\public\footer.html";i:1488521154;}*/ ?>
<!DOCTYPE html>
<html lang="zh-CN">
  <head>
    <meta charset="utf-8">
...
<div class="controllerbut">
  <a href="<?php echo url('create'); ?>" class="button button-primary button-rounded button-small">添加</a>
    <a  class="button psc button-caution button-rounded button-small">批量删除</a>
       ...
       <form>
         <?php if(is_array($list) || $list instanceof \think\Collection || $list instanceof \think\Paginator): $i = 0; $__LIST__ = $list;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$vo): $mod = ($i % 2 );++$i;?>
           <tr>
             ...
             <td data-id="<?php echo $vo['id']; ?>" class="clicksort"><?php echo $vo['slide_sort']; ?></td>                        
             <td><?php echo $vo['createtime']; ?></td>
            <td><?php echo $vo['updatetime']; ?></td>
           <td>
            <a href="<?php echo url('edit',['id' =>$vo['id']]); ?>" class="button button-action button-rounded button-tiny">编辑</a>
