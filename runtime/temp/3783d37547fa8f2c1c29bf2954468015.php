<?php if (!defined('THINK_PATH')) exit(); /*a:4:{s:87:"G:\xampp\htdocs\liangxing\public/../application/admin\view\articlelist\articlelist.html";i:1488525658;s:77:"G:\xampp\htdocs\liangxing\public/../application/admin\view\public\header.html";i:1490583024;s:75:"G:\xampp\htdocs\liangxing\public/../application/admin\view\public\left.html";i:1490251414;s:77:"G:\xampp\htdocs\liangxing\public/../application/admin\view\public\footer.html";i:1488521154;}*/ ?>
<!DOCTYPE html>
<html lang="zh-CN">
  <head>
    <meta charset="utf-8">
...
<form method="get" action="<?php echo url('/admin/articlelist'); ?>" >
...
<!--  -->       <?php if(is_array($pro) || $pro instanceof \think\Collection || $pro instanceof \think\Paginator): $i = 0; $__LIST__ = $pro;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$vo): $mod = ($i % 2 );++$i;?>
           <tr>
             ...
             <td data-id="<?php echo $vo['id']; ?>" class="clicksortwz"><?php echo $vo['sort']; ?></td>
