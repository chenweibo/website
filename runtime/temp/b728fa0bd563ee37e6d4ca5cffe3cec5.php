<?php if (!defined('THINK_PATH')) exit(); /*a:4:{s:70:"G:\xampp\htdocs\jieapi\public/../application/admin\view\file\file.html";i:1490247849;s:74:"G:\xampp\htdocs\jieapi\public/../application/admin\view\public\header.html";i:1490082824;s:72:"G:\xampp\htdocs\jieapi\public/../application/admin\view\public\left.html";i:1490248671;s:74:"G:\xampp\htdocs\jieapi\public/../application/admin\view\public\footer.html";i:1488521154;}*/ ?>
<!DOCTYPE html>
<html lang="zh-CN">
  <head>
    <meta charset="utf-8">
...
<script type="text/javascript" src="__static__/UEditor/lang/zh-cn/zh-cn.js"></script> 
  ...
  <div class="modal-dialog">
   ...
   <script type="text/javascript">
     ...
     $(".gaoliang .nav:eq(2) li:eq(2)").addClass('active');
...
<div class="panel panel-default filec" >
<div class="row">
 ...
 <div class="col-sm-6 col-md-2 " id="k<?php echo $k; ?>">
  
    <div class="thumbnail">
       <img   style="height:215px" class="fileimg"  src="/uploads/<?php echo $vo; ?>" alt="">
      <div class="caption">

        <p><?php echo $vo; ?></p>
        <p><a data-id="<?php echo $vo; ?>"  class="btn btn-default filedelete" role="button">删除</a>&nbsp;&nbsp;文件删除后无法恢复</p>
      </div>
    </div>
  </div>
...
$(".filedelete").click(function(){
  ...
  var id = $(".filedelete").data("id");
  var e = $(this).parent().parent().parent().parent().attr("id");
          $.ajax({
