<?php if (!defined('THINK_PATH')) exit(); /*a:4:{s:74:"G:\xampp\htdocs\jiepai\public/../application/admin\view\others\others.html";i:1488952409;s:74:"G:\xampp\htdocs\jiepai\public/../application/admin\view\public\header.html";i:1489116326;s:72:"G:\xampp\htdocs\jiepai\public/../application/admin\view\public\left.html";i:1489041904;s:74:"G:\xampp\htdocs\jiepai\public/../application/admin\view\public\footer.html";i:1488521154;}*/ ?>
<!DOCTYPE html>
<html lang="zh-CN">
  <head>
    <meta charset="utf-8">
...
<script type="text/javascript" src="__static__/UEditor/lang/zh-cn/zh-cn.js"></script> 
  ...
  <div class="modal-dialog">
   ...
   <script type="text/javascript">
     ...
     $(".gaoliang .nav:eq(0) li:eq(1)").addClass('active');
  
   </script>

  <div class="col-sm-9 col-sm-offset-3 col-md-10 col-md-offset-2 main">
          <h1 class="page-header">其他设置</h1>

<form class="form-horizontal" method="post" action="<?php echo url('save'); ?>" id="cess"  role="form"   style="margin-top:80px">
  <div class="form-group form-group-lg">
    <label class="col-sm-1 control-label" for="formGroupInputLarge">友情连接</label>
    <div class="col-sm-10">
      <input class="form-control" name="link" value="<?php echo $others['link']; ?>" type="text" id="formGroupInputLarge" placeholder="友情连接">
    </div>
  </div>
