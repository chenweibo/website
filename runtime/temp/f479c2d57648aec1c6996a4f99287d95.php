<?php if (!defined('THINK_PATH')) exit(); /*a:4:{s:87:"G:\xampp\htdocs\liangxing\public/../application/admin\view\productcate\productcate.html";i:1489646032;s:77:"G:\xampp\htdocs\liangxing\public/../application/admin\view\public\header.html";i:1490583024;s:75:"G:\xampp\htdocs\liangxing\public/../application/admin\view\public\left.html";i:1490251414;s:77:"G:\xampp\htdocs\liangxing\public/../application/admin\view\public\footer.html";i:1488521154;}*/ ?>
<!DOCTYPE html>
<html lang="zh-CN">
  <head>
    <meta charset="utf-8">
...
<form>
 <div class="row" style="margin-bottom:20px">
  ...
  <option  data-path='<?php echo $vo['path']; ?>'  value="<?php echo $vo['id']; ?>" ><?php echo $vo['html']; ?><?php echo $vo['name']; ?></option>
    ...
    <tbody>
       ...
       <?php if(is_array($list) || $list instanceof \think\Collection || $list instanceof \think\Paginator): $i = 0; $__LIST__ = $list;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$vo): $mod = ($i % 2 );++$i;?>
           <tr>
             ...
             <td data-id="<?php echo $vo['id']; ?>" class="clicksort1"><?php echo $vo['sort']; ?></td> 
