<?php if (!defined('THINK_PATH')) exit(); /*a:4:{s:81:"G:\xampp\htdocs\liangxing\public/../application/admin\view\downlist\downlist.html";i:1488525609;s:77:"G:\xampp\htdocs\liangxing\public/../application/admin\view\public\header.html";i:1490583024;s:75:"G:\xampp\htdocs\liangxing\public/../application/admin\view\public\left.html";i:1490251414;s:77:"G:\xampp\htdocs\liangxing\public/../application/admin\view\public\footer.html";i:1488521154;}*/ ?>
<!DOCTYPE html>
<html lang="zh-CN">
  <head>
    <meta charset="utf-8">
...
<script type="text/javascript" src="__static__/UEditor/lang/zh-cn/zh-cn.js"></script> 
  ...
  <div class="modal-dialog">
   ...
   <script type="text/javascript">
     ...
     $(".gaoliang .nav:eq(1) li:eq(7)").addClass('active');
...
<div class="controllerbut">
  <a href="<?php echo url('create',['pid'=>$pid]); ?>" class="button button-primary button-rounded button-small">添加</a>
    <a  class="button dlan  button-caution button-rounded button-small">批量删除</a>
   
</div>

<form method="get" action="<?php echo url('/admin/downlist'); ?>" >
    ...
    <tbody>
      ...
      <?php if(is_array($pro) || $pro instanceof \think\Collection || $pro instanceof \think\Paginator): $i = 0; $__LIST__ = $pro;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$vo): $mod = ($i % 2 );++$i;?>
           ...
           <tr>
             ...
             <td data-id="<?php echo $vo['id']; ?>" class="cdlit"><?php echo $vo['sort']; ?></td>
...
$(".cdlit").click(function(){
//123
var td = $(this);


var txt = td.text();
var id = $(".cdlit").data("id");
...
td.html(newtxt);
 ...
 var id=td.data('id');
     $.ajax({
              ...
              type:'POST',
              url:'/admin/downlist/ajaxsortupdate' ,
