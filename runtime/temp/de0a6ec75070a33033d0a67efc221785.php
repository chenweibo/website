<?php if (!defined('THINK_PATH')) exit(); /*a:4:{s:77:"G:\xampp\htdocs\jieapi\public/../application/admin\view\articlelist\edit.html";i:1490251507;s:74:"G:\xampp\htdocs\jieapi\public/../application/admin\view\public\header.html";i:1490082824;s:72:"G:\xampp\htdocs\jieapi\public/../application/admin\view\public\left.html";i:1490251414;s:74:"G:\xampp\htdocs\jieapi\public/../application/admin\view\public\footer.html";i:1488521154;}*/ ?>
<!DOCTYPE html>
<html lang="zh-CN">
  <head>
    <meta charset="utf-8">
...
selected="select"<?php endif; ?>  value="<?php echo $vo['path']; ?>-<?php echo $vo['id']; ?>" ><?php echo $vo['html']; ?><?php echo $vo['name']; ?></option>
  ...
  <?php endforeach; endif; else: echo "" ;endif; ?>
      ...
      <div class="form-group form-group-lg">
    <label class="col-sm-1 control-label" for="formGroupInputLarge">发布时间</label>
    <div class="col-sm-10">
        <div class="input-group date form_date col-md-5" data-date="" data-date-format="dd MM yyyy" data-link-field="dtp_input2"  data-link-format="yyyy-mm-dd">
                    <input class="form-control" value="<?php echo $data['time']; ?>" settime size="16" type="text" name="time"  readonly>
