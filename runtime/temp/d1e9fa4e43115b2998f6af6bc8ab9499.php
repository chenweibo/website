<?php if (!defined('THINK_PATH')) exit(); /*a:4:{s:83:"G:\xampp\htdocs\liangxing\public/../application/admin\view\imagecate\imagecate.html";i:1488524171;s:77:"G:\xampp\htdocs\liangxing\public/../application/admin\view\public\header.html";i:1490583024;s:75:"G:\xampp\htdocs\liangxing\public/../application/admin\view\public\left.html";i:1490251414;s:77:"G:\xampp\htdocs\liangxing\public/../application/admin\view\public\footer.html";i:1488521154;}*/ ?>
   <!DOCTYPE html>
<html lang="zh-CN">
  <head>
    <meta charset="utf-8">
...
<script type="text/javascript" src="__static__/UEditor/lang/zh-cn/zh-cn.js"></script> 
  ...
  <div class="modal-dialog">
   ...
   <script type="text/javascript">
     ...
     $(".gaoliang .nav:eq(1) li:eq(4)").addClass('active');
  
   </script>

  <div class="col-sm-9 col-sm-offset-3 col-md-10 col-md-offset-2 main">
          <h1 class="page-header">图片分类</h1>
<div class="controllerbut">
  <a href="<?php echo url('create'); ?>" class="button button-primary button-rounded button-small">添加</a>
    <a  class="button pscaimgcate button-caution button-rounded button-small">批量删除</a>
    ...
    <tbody>
       ...
       <?php if(is_array($list) || $list instanceof \think\Collection || $list instanceof \think\Paginator): $i = 0; $__LIST__ = $list;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$vo): $mod = ($i % 2 );++$i;?>
           <tr>
             ...
             <td><?php echo $vo['html']; ?><?php echo $vo['name']; ?></td>
             <td data-id="<?php echo $vo['id']; ?>" class="clicksortim"><?php echo $vo['sort']; ?></td>                        
             <td><?php echo $vo['createtime']; ?></td>
            <td><?php echo $vo['updatetime']; ?></td>
           <td>
            <a href="<?php echo url('create',['pid' =>$vo['id']]); ?>" class="button button-action button-rounded button-tiny">添加子分类</a>
...
chk_value.push($(this).val()); 
          ...
          $.ajax({
              ...
              type:'POST',
              url:'/admin/imagecate/ajaxdelete' ,
              data: { "id" :chk_value } ,  
              dataType:'json',
...
$(".clicksortim").click(function(){
//123
var td = $(this);


var txt = td.text();
var id = $(".clicksortim").data("id");
...
td.html(newtxt);
 ...
 var id=td.data('id');
     $.ajax({
              ...
              type:'POST',
              url:'/admin/imagecate/ajaxsortupdate' ,
