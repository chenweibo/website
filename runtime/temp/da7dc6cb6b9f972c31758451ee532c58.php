<?php if (!defined('THINK_PATH')) exit(); /*a:4:{s:71:"G:\xampp\htdocs\jieapi\public/../application/admin\view\gbook\read.html";i:1489042816;s:74:"G:\xampp\htdocs\jieapi\public/../application/admin\view\public\header.html";i:1489728277;s:72:"G:\xampp\htdocs\jieapi\public/../application/admin\view\public\left.html";i:1490074002;s:74:"G:\xampp\htdocs\jieapi\public/../application/admin\view\public\footer.html";i:1488521154;}*/ ?>
<!DOCTYPE html>
<html lang="zh-CN">
  <head>
    <meta charset="utf-8">
...
<script type="text/javascript" src="__static__/UEditor/lang/zh-cn/zh-cn.js"></script> 
  ...
  <div class="modal-dialog">
   ...
   <script type="text/javascript">
     ...
     $(".gaoliang .nav:eq(0) li:eq(4)").addClass('active');
  
   </script>

  <div class="col-sm-9 col-sm-offset-3 col-md-10 col-md-offset-2 main">
          <h1 class="page-header">建议反馈</h1>

<form class="form-horizontal" method="post" action="<?php echo url('save'); ?>" id="cess"  role="form"   style="margin-top:80px">

    
    <div class="form-group form-group-lg">
    <label class="col-sm-1 control-label" for="formGroupInputLarge">问题</label>
    <div class="col-sm-10">
      <input class="form-control" name="name"  value="<?php echo $data['question']; ?>" type="text" id="formGroupInputLarge" placeholder="问题"  disabled>
    </div>
  </div>
    ...
    <div class="col-sm-10">
      <input class="form-control" name="name"  value="<?php echo $data['xingming']; ?>" type="text" id="formGroupInputLarge" placeholder="姓名"  disabled>
    </div>
  </div>

      <div class="form-group form-group-lg">
    <label class="col-sm-1 control-label" for="formGroupInputLarge">邮箱</label>
    <div class="col-sm-10">
      <input class="form-control" name="name"  value="<?php echo $data['email']; ?>" type="text" id="formGroupInputLarge" placeholder="邮箱" disabled>
    </div>
  </div>
...
<textarea class="form-control" rows="10" disabled>
 ...
 <label class="col-sm-1 control-label sr-only" for="formGroupInputLarge">提交修改按钮</label>
   <div class="col-sm-10">
   <a href="javascript;" onclick="history.go(-1)" class="button button-3d button-primary button-rounded">返回</a>
   </div>
     </div>
