<?php if (!defined('THINK_PATH')) exit(); /*a:4:{s:71:"G:\xampp\htdocs\jieapi\public/../application/admin\view\slide\edit.html";i:1488179693;s:74:"G:\xampp\htdocs\jieapi\public/../application/admin\view\public\header.html";i:1490063903;s:72:"G:\xampp\htdocs\jieapi\public/../application/admin\view\public\left.html";i:1490072645;s:74:"G:\xampp\htdocs\jieapi\public/../application/admin\view\public\footer.html";i:1488521154;}*/ ?>
<!DOCTYPE html>
<html lang="zh-CN">
  <head>
    <meta charset="utf-8">
...
<script type="text/javascript" src="__static__/UEditor/lang/zh-cn/zh-cn.js"></script> 
    ...
    <nav class="navbar navbar-inverse navbar-fixed-top">
      <div class="container-fluid">
        <div class="navbar-header">
          ...
          <a class="navbar-brand" href="<?php echo url('/admin/index'); ?>">网站后台管理</a>
        </div>
  ...
  <div class="modal-dialog">
      ...
      <div class="row">
        ...
        <div class="col-sm-3 col-md-2 sidebar gaoliang">
          <ul class="nav nav-sidebar">
            ...
            <li><a href="/admin_slide"><span class="glyphicon glyphicon-plus-sign" aria-hidden="true"></span> 首页幻灯片</a></li>
          ...
          <ul class="nav nav-sidebar">
            <li style="display:none;"><a href=""><span class="glyphicon glyphicon-trash" aria-hidden="true"></span> 回收站</a></li>
   ...
   <script type="text/javascript">
     ...
     $(".gaoliang .nav:eq(0) li:eq(2)").addClass('active');
  
   </script>

  <div class="col-sm-9 col-sm-offset-3 col-md-10 col-md-offset-2 main">
          <h1 class="page-header">幻灯片设置</h1>
...
<form class="form-horizontal" method="post" action="<?php echo url('update'); ?>" id="cess"  role="form"   style="margin-top:80px">
    ...
    <div class="col-sm-10">
      <input class="form-control" name="slide_name"  value="<?php echo $data['slide_name']; ?>" type="text" id="formGroupInputLarge" placeholder="标题">
    </div>
  </div>

             <div class="form-group form-group-lg">
    <label class="col-sm-1 control-label" for="formGroupInputLarge">链接</label>
    <div class="col-sm-10">
      <input class="form-control" name="slide_a"  value="<?php echo $data['slide_a']; ?>" type="text" id="formGroupInputLarge" placeholder="链接">
    </div>
  </div>


    <div class="form-group form-group-lg" >
    <label class="col-sm-1 control-label" for="formGroupInputLarge">图片上传</label>
