<?php if (!defined('THINK_PATH')) exit(); /*a:4:{s:72:"G:\xampp\htdocs\jiepai\public/../application/index\view\honor\honor.html";i:1488873613;s:74:"G:\xampp\htdocs\jiepai\public/../application/index\view\public\header.html";i:1489022104;s:72:"G:\xampp\htdocs\jiepai\public/../application/index\view\public\news.html";i:1488862658;s:72:"G:\xampp\htdocs\jiepai\public/../application/index\view\public\foot.html";i:1488953097;}*/ ?>
...
<head>
	...
	<title>荣誉资质-<?php echo $system['title']; ?></title>
	...
	<link rel="stylesheet" href="__home__/css/viewer.min.css" />
...
<div>
  ...
  <script type="text/javascript">
	...
	<section class="banner">
	    <div><img src="__home__/images/about_banner.jpg" alt=""></div>
	</section>
	<div class="com_zi clearfix">
		<div class="left_zi">
			...
			<ul class="nav_left">
				...
				<li  class="active"><a href="honor">荣誉资质</a></li>
	...
	<?php endforeach; endif; else: echo "" ;endif; ?>				
		...
		<div class="right_zi">
			<div class="bar clearfix">
				<span class="b_tt">荣誉资质</span>
				<span class="curbar"><i>您当前的位置：</i><a href="/">首页</a>  > <i>荣誉资质</i></span>
			</div>
			...
			<?php if(is_array($list) || $list instanceof \think\Collection || $list instanceof \think\Paginator): $i = 0; $__LIST__ = $list;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$vo): $mod = ($i % 2 );++$i;?>
				<li>
					<div class="pic">
						<img src="<?php echo $vo['icon']; ?>" alt="" class="vcenter" />
						<i></i>
					</div>
					<p>质量保证中心</p>
				</li>
...
<script type="text/javascript" src="__home__/js/viewer.min.js">
