<?php if (!defined('THINK_PATH')) exit(); /*a:4:{s:75:"G:\xampp\htdocs\liangxing\public/../application/admin\view\index\index.html";i:1490584193;s:77:"G:\xampp\htdocs\liangxing\public/../application/admin\view\public\header.html";i:1490583024;s:75:"G:\xampp\htdocs\liangxing\public/../application/admin\view\public\left.html";i:1490251414;s:77:"G:\xampp\htdocs\liangxing\public/../application/admin\view\public\footer.html";i:1488521154;}*/ ?>
<!DOCTYPE html>
<html lang="zh-CN">
  <head>
    <meta charset="utf-8">
...
<div class="progress">
  <div class="progress-bar progress-bar-success progress-bar-striped active" role="progressbar" aria-valuenow="40" aria-valuemin="0" aria-valuemax="100" style="width: <?php echo $page*2; ?>%">
    <?php echo $page; ?> page (单篇页面)
  </div>
</div>
<div class="progress">
  <div class="progress-bar progress-bar-info progress-bar-striped active" role="progressbar" aria-valuenow="20" aria-valuemin="0" aria-valuemax="100" style="width: <?php echo $artcount*2; ?>%">
   <?php echo $artcount; ?>article(文章)
  </div>
</div>
<div class="progress">
  <div class="progress-bar progress-bar-warning progress-bar-striped active" role="progressbar" aria-valuenow="60" aria-valuemin="0" aria-valuemax="100" style="width: <?php echo $procount/2; ?>%">
   <?php echo $procount; ?> product (产品)
  </div>
</div>
<div class="progress">
  <div class="progress-bar progress-bar-danger progress-bar-striped active" role="progressbar" aria-valuenow="80" aria-valuemin="0" aria-valuemax="100" style="width: <?php echo $imgcount; ?>%">
 <?php if(empty($imgcount) || (($imgcount instanceof \think\Collection || $imgcount instanceof \think\Paginator ) && $imgcount->isEmpty())): ?>暂时没有数据<?php else: ?><?php echo $imgcount; ?> images (图片)<?php endif; ?>
  </div>

  <?php if(empty($imgcount) || (($imgcount instanceof \think\Collection || $imgcount instanceof \think\Paginator ) && $imgcount->isEmpty())): ?>暂时没有数据<?php endif; ?>
</div>
