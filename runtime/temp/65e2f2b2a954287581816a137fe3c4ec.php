<?php if (!defined('THINK_PATH')) exit(); /*a:4:{s:80:"G:\xampp\htdocs\liangxing\public/../application/admin\view\productlist\edit.html";i:1490687435;s:77:"G:\xampp\htdocs\liangxing\public/../application/admin\view\public\header.html";i:1490583024;s:75:"G:\xampp\htdocs\liangxing\public/../application/admin\view\public\left.html";i:1490251414;s:77:"G:\xampp\htdocs\liangxing\public/../application/admin\view\public\footer.html";i:1488521154;}*/ ?>
<!DOCTYPE html>
<html lang="zh-CN">
  <head>
    <meta charset="utf-8">
...
selected="select"<?php endif; ?>  value="<?php echo $vo['path']; ?>-<?php echo $vo['id']; ?>" ><?php echo $vo['html']; ?><?php echo $vo['name']; ?></option>
  ...
  <?php endforeach; endif; else: echo "" ;endif; ?>
    ...
    <div class="col-sm-10">
      <textarea class="form-control" rows="5" name="gaishu">  <?php echo $data['gaishu']; ?></textarea>
    </div>
  </div>
      <div class="form-group form-group-lg">
...
<div id='pt<?php echo $k; ?>'  class='pic'><a onclick="aaat(<?php echo $k; ?>)"   class='button button-circle button-tiny xxt xxt<?php echo $k; ?>' style='font-size:18px;'>×</a><img class="xz"  src="/uploads/<?php echo $v; ?>"></div>
