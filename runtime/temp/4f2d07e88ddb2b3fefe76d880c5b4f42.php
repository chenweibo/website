<?php if (!defined('THINK_PATH')) exit(); /*a:4:{s:77:"G:\xampp\htdocs\jieapi\public/../application/admin\view\productlist\edit.html";i:1489986500;s:74:"G:\xampp\htdocs\jieapi\public/../application/admin\view\public\header.html";i:1490082824;s:72:"G:\xampp\htdocs\jieapi\public/../application/admin\view\public\left.html";i:1490248671;s:74:"G:\xampp\htdocs\jieapi\public/../application/admin\view\public\footer.html";i:1488521154;}*/ ?>
<!DOCTYPE html>
<html lang="zh-CN">
  <head>
    <meta charset="utf-8">
...
<form class="form-horizontal" method="post" action="<?php echo url('update'); ?>" id="cess"  role="form"   style="margin-top:80px">
    ...
    <div class="col-sm-10">
      <input class="form-control" name="p_jintai"  value="<?php echo $data['p_jintai']; ?>" type="text" id="formGroupInputLarge" placeholder="伪静态名称">
    </div>
  </div>
      <div class="form-group form-group-lg">
...
selected="select"<?php endif; ?>  value="<?php echo $vo['path']; ?>-<?php echo $vo['id']; ?>" ><?php echo $vo['html']; ?><?php echo $vo['name']; ?></option>
  ...
  <?php endforeach; endif; else: echo "" ;endif; ?>
    ...
    <div class="col-sm-10">
      <input class="form-control" name="pageview" style="width:100px"  value="<?php echo $data['pageview']; ?>" type="text" id="formGroupInputLarge" placeholder="点击量">
    </div>
  </div>
      <div class="form-group form-group-lg">
    ...
    <div class="col-sm-10">
                ...
                <input id="photoCover" name="icon" class="form-control" type="text" value="<?php echo $data['icon']; ?>" name="icon" >
    ...
    <div class="duotu clearfix" style="width:100%">
          <?php if(is_array($str) || $str instanceof \think\Collection || $str instanceof \think\Paginator): $k = 0; $__LIST__ = $str;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$v): $mod = ($k % 2 );++$k;?>

<div id='pt<?php echo $k; ?>'  class='pic'><a onclick="aaat(<?php echo $k; ?>)"   class='button button-circle button-tiny xxt xxt<?php echo $k; ?>' style='font-size:18px;'>×</a><img  src="/uploads/<?php echo $v; ?>"></div>
 ...
 <div></div>
      ...
      var i=$('.pic').length;
       ...
       var formData = new FormData($( "#cess" )[0]);  
         $.ajax({  
          ...
          i++;
  $('.duotu').append("<div id='pt"+i+"'  class='pic'><a   class='button button-circle button-tiny xxt xxt"+i+"' style='font-size:18px;'>×</a><img  src="+'/uploads/'+data+"></div>");
  ...
  <input class="imgmore" type="hidden" name="imgmore" value="<?php echo $data['imgmore']; ?>">
    ...
    <div class="col-sm-10">
                ...
                <input id="photoCover1" name="down" class="form-control" type="text" value="<?php echo $data['down']; ?>"  >
    ...
    <div class="col-sm-10">
      <input class="form-control" name="keywords"  value="<?php echo $data['keywords']; ?>" type="text" id="formGroupInputLarge" placeholder="关键词">
    </div>
  </div>
      <div class="form-group form-group-lg">
    <label class="col-sm-1 control-label" for="formGroupInputLarge">SEO描述</label>
    <div class="col-sm-10">
      <input class="form-control" name="description"  value="<?php echo $data['description']; ?>" type="text" id="formGroupInputLarge" placeholder="描述">
    </div>
  </div>
    ...
    <div class="col-sm-10">
      ...
      <input type="radio" id="checkboxWarning" name="lang" <?php if($data['lang'] == 'cn'): ?>
checked="checked"
<?php endif; ?> value="cn">
       中文
    
     
      <input type="radio"  id="checkboxWarning"<?php if($data['lang'] == 'en'): ?>
checked="checked"<?php endif; ?>   name="lang"  value="en">
       英文
    ...
    <div class="col-sm-10">
      ...
      <input type="radio" id="checkboxWarning"  name="show" checked="checked"<?php if($data['show'] == '1'): ?>
checked="checked"<?php endif; ?>  value="1">
       显示
    
     
      <input type="radio" <?php if($data['show'] == '0'): ?>
checked="checked"<?php endif; ?> id="checkboxWarning" name="show"  value="0">
       隐藏
    ...
    <div class="col-sm-10">
      ...
      <input type="radio" id="checkboxWarning" <?php if($data['recommend'] == '1'): ?>
checked="checked"<?php endif; ?> name="recommend"  value="1">
       推荐
    
     
      <input type="radio" id="checkboxWarning"<?php if($data['recommend'] == '0'): ?>
checked="checked"<?php endif; ?> checked="checked" name="recommend"  value="0">
       不推荐  (首页没推荐的可以无视)
