<?php if (!defined('THINK_PATH')) exit(); /*a:4:{s:77:"G:\xampp\htdocs\jieapi\public/../application/admin\view\productcate\edit.html";i:1489986311;s:74:"G:\xampp\htdocs\jieapi\public/../application/admin\view\public\header.html";i:1489728277;s:72:"G:\xampp\htdocs\jieapi\public/../application/admin\view\public\left.html";i:1490074002;s:74:"G:\xampp\htdocs\jieapi\public/../application/admin\view\public\footer.html";i:1488521154;}*/ ?>
<!DOCTYPE html>
<html lang="zh-CN">
  <head>
    <meta charset="utf-8">
...
<form class="form-horizontal" method="post" action="<?php echo url('update'); ?>" id="cess"  role="form"   style="margin-top:80px">
    ...
    <div class="col-sm-10">
      <input class="form-control" name="jingtai"  value="<?php echo $data['jingtai']; ?>" type="text" id="formGroupInputLarge" placeholder="伪静态名称">
    </div>
  </div>
