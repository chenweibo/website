...
<form class="form-horizontal" method="post" action="/admin_slide" id="cess"  role="form"   style="margin-top:80px">

    
    <div class="form-group form-group-lg">
    <label class="col-sm-1 control-label" for="formGroupInputLarge">标题</label>
    <div class="col-sm-10">
      <input class="form-control" name="slide_name"  value="" type="text" id="formGroupInputLarge" placeholder="标题">
    </div>
  </div>
    ...
    <div class="col-sm-10">
      <input class="form-control" name="slide_a"  value="" type="text" id="formGroupInputLarge" placeholder="标题">
    </div>
  </div>
