<?php if (!defined('THINK_PATH')) exit(); /*a:3:{s:76:"/www/wwwroot/o.dqzd.cpm/public/../application/index/view/news/news_show.html";i:1489368848;s:75:"/www/wwwroot/o.dqzd.cpm/public/../application/index/view/public/header.html";i:1489367484;s:73:"/www/wwwroot/o.dqzd.cpm/public/../application/index/view/public/foot.html";i:1489212144;}*/ ?>
﻿<!DOCTYPE html>
<html>
<head>
    ...
    <div class="eleven columns m-bot-25"> 
      ...
      <div class="blog-item m-bot-35 clearfix">
        <div class="hover-item">
          <div class="blog-item-caption-container padding-left-0"> <a class="a-invert" href="blog-single.html" ><span class="bold"><?php echo $data['name']; ?></a>
            <div class="lp-item-container-border clearfix">
              <div class="blog-info-container">
                <ul class="clearfix">
                  <li class="view"><?php echo $data['pageview']; ?></li>
                  <li class="tag"><?php echo date("Y-m-d",$data['createtime']); ?> </li>
                </ul>
              </div>
            </div>
          </div>
        </div>
        <div class="blog-item-text-container minh500 margin-left-0">
         <?php echo $data['info']; ?>
        </div>
      </div>
    </div>
