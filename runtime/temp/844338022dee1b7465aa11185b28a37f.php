<?php if (!defined('THINK_PATH')) exit(); /*a:4:{s:74:"G:\xampp\htdocs\jieapi\public/../application/admin\view\system\system.html";i:1488176781;s:74:"G:\xampp\htdocs\jieapi\public/../application/admin\view\public\header.html";i:1490082824;s:72:"G:\xampp\htdocs\jieapi\public/../application/admin\view\public\left.html";i:1490251414;s:74:"G:\xampp\htdocs\jieapi\public/../application/admin\view\public\footer.html";i:1488521154;}*/ ?>
<!DOCTYPE html>
<html lang="zh-CN">
  <head>
    <meta charset="utf-8">
...
<script type="text/javascript" src="__static__/UEditor/lang/zh-cn/zh-cn.js"></script> 
  ...
  <div class="modal-dialog">
   ...
   <script type="text/javascript">
     ...
     $(".gaoliang .nav:eq(0) li:eq(0)").addClass('active');
...
<form class="form-horizontal" method="post" action="<?php echo url('save'); ?>" id="cess"  role="form"   style="margin-top:80px">
  <div class="form-group form-group-lg">
    <label class="col-sm-1 control-label" for="formGroupInputLarge">网站标题</label>
    <div class="col-sm-10">
      <input class="form-control" name="title" value="<?php echo $system['title']; ?>" type="text" id="formGroupInputLarge" placeholder="网站标题">
    </div>
  </div>

    <div class="form-group form-group-lg">
    <label class="text-left col-sm-1 control-label " for="formGroupInputLarge">关键字</label>
    <div class="col-sm-10">
      <input class="form-control"  name="keywords" value="<?php echo $system['keywords']; ?>" type="text" id="formGroupInputLarge" placeholder="关键字">
    </div>
  </div>


      <div class="form-group form-group-lg">
    <label class="col-sm-1 control-label" for="formGroupInputLarge">网站描述</label>
    <div class="col-sm-10">
      <input class="form-control" name="description"  value="<?php echo $system['description']; ?>" type="text" id="formGroupInputLarge" placeholder="网站描述">
    </div>
  </div>

    <div class="form-group form-group-lg" >
    <label class="col-sm-1 control-label" for="formGroupInputLarge">LOGO</label>
    ...
    <div class="col-sm-10">
                ...
                <input id="photoCover" name="icon" class="form-control" type="text" value="<?php echo $system['icon']; ?>" name="icon" >
      ...
      <div class="form-group form-group-lg">
    <label class="col-sm-1 control-label" for="formGroupInputLarge">电话号码</label>
    <div class="col-sm-10">
      <input class="form-control" name="tel" value="<?php echo $system['tel']; ?>" type="text" id="formGroupInputLarge" placeholder="电话号码">
    </div>
  </div>

      <div class="form-group form-group-lg">
    <label class="col-sm-1 control-label" for="formGroupInputLarge">企业名称</label>
    <div class="col-sm-10">
      <input class="form-control" name="company" value="<?php echo $system['company']; ?>" type="text" id="formGroupInputLarge" placeholder="企业名称">
    </div>
  </div>

      <div class="form-group form-group-lg">
    <label class="col-sm-1 control-label" for="formGroupInputLarge">企业地址</label>
    <div class="col-sm-10">
      <input class="form-control" name="address" value="<?php echo $system['address']; ?>" type="text" id="formGroupInputLarge" placeholder="企业地址">
    </div>
  </div>

      <div class="form-group form-group-lg">
    <label class="col-sm-1 control-label" for="formGroupInputLarge">邮政编码</label>
    <div class="col-sm-10">
      <input class="form-control" name="zipcode" value="<?php echo $system['zipcode']; ?>" type="text" id="formGroupInputLarge" placeholder="邮政编码">
    </div>
  </div>
      <div class="form-group form-group-lg">
    <label class="col-sm-1 control-label" for="formGroupInputLarge">企业邮箱</label>
    <div class="col-sm-10">
      <input class="form-control" name="email" value="<?php echo $system['email']; ?>" type="text" id="formGroupInputLarge" placeholder="请输入企业邮箱">
    </div>
  </div>
 <div class="form-group form-group-lg">
